    ...
    <div class="col-lg-8 offset-lg-2">
        ...
        <form method="POST" action="{{ route('medications.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="medecine_family">
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="3" cols="30" name="presentation"></textarea>
            </div>

           <div class="form-group">
                <label>Observation</label>
                <textarea class="form-control" rows="3" cols="30" name="observation"></textarea>
            </div>

            <div class="m-t-20 text-center">
                <button class="btn btn-primary submit-btn">Ajouter Médicament</button>
            </div>
        </form>
    </div>
</div>
