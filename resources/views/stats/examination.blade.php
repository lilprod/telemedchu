...
<div class="row">
    <div class="col-sm-5 col-4">
        <h4 class="page-title">Examinations</h4>
    </div>
...
<div class="row">
	...
	<div class="card">
		<div class="card-header">
			<h4 class="card-title d-inline-block"> Etats de examens demandés sur une période </h4> 
		...
		<div class="card-body p-0">
			...
			<div class="table-responsive">
				<h5 align="center"><b>Total de examen(s) :</b> <span id="total_records"></span></h5>
