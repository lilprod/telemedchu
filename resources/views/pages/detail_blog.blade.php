...
<meta name="description" content="{!!  str_limit($post->body, 20) !!}">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta property="og:site_name" content="CHU CAMPUS +" />
<meta property="og:url" content="{{route('sante.show', $post->slug)}}" />
<meta property="og:title" content="{{$post->title}}" />
<meta property="og:type" content="article" />
<meta property="og:image" content="{{ Storage::disk('public')->url('/app/public/public/cover_images/'.$post->cover_image) }}" />

<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:title" content="{{$post->title}}">
<meta property="twitter:description" content="{!!  str_limit($post->body, 20) !!}">
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title"> Santé | {{$post->title}}</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="button info_button"><a href="{{route('blog.index')}}"><span>retour</span><span>retour</span></a></div>
				</div>
									...
									<div class="latest_content">
										...
										<div class="latest_info">
											<ul class="d-flex flex-row align-items-start justify-content-start">
												<li><a href="{{route('sante.show', $post->slug)}}">{{ $post->username}}</a></li>
												<li><a href="{{route('sante.show', $post->slug)}}">{{ $post->created_at}}</a></li>
											</ul>
										</div>
