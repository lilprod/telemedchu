...
<meta property="og:url" content="{{route('timeline.show', $post->slug)}}" />
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Actualités | {{$post->title}}</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
					...
					<div class="news_posts">
						<div class="news_post">
							...
							<div class="news_post_content">
								<div class="news_post_date"><a href="{{route('timeline.show', $post->slug)}}">{{$post->created_at->format('d/m/Y')}}</a></div>
								...
								<div class="news_post_text">
									<p style="text-align: justify-all;">{!! ($post->body) !!} </p>
								</div>
							</div>
						</div>
					</div>
                ...
                <div class="addthis_inline_share_toolbox"></div>
					...
					<div class="button info_button"><a href="{{route('timeline')}}"><span>retour</span><span>retour</span></a></div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_about">
							...
							<div class="copyright">
								&copy; <script>document.write(new Date().getFullYear());</script> CHU CAMPUS | Développé <!--<i class="fa fa-heart-o" aria-hidden="true"></i>--> par l'<a href="https://telemedchucampus.tg#unite" target="_blank"> Unité de Télémedecine du CHU-CAMPUS</a>
							</div>
						</div>
					</div>
