...
<html lang="fr">
<head>
<title>Santé | {{config('app.name', 'Telemedecine')}}</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Les articles de santé des Médecins du Centre Hospitalier Universitaire CAMPUS">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta property="og:site_name" content="CHU CAMPUS +" />
<meta property="og:url" content="https://telemedchucampus.tg/blog" />
<meta property="og:title" content="Les articles de santé des Médecins du CHU CAMPUS de Lomé" />
<meta property="og:type" content="website" />
<meta property="og:image" content="https://telemedchucampus.tg/assets/images/index-hero2.jpg" />

<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:title" content="Les articles de santé des Médecins du CHU CAMPUS de Lomé">
<meta property="twitter:description" content="Les articles de santé des Médecins du Centre Hospitalier Universitaire CAMPUS de Lomé">
										...
										<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
											<nav class="main_nav">
												<ul class="d-flex flex-row align-items-center justify-content-start">
													...
													<li class="active"><a href="{{ route('blog.index') }}">Santé</a></li>
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Santé</div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="news_posts">
                        ...
                        <div class="news_post">
							<div class="news_post_content">
							    <div class="news_post_title"><a href="#">Rispote continue du COVID 19</a></div>
							    <div class="news_post_text videoWrapper">
							    <iframe width="560" height="315" src="https://www.youtube.com/embed/IQy6JO_VpIU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							    </div>
							</div>
						</div>
						...
						<div class="news_post">
							...
							<div class="news_post_content">
								<div class="news_post_date"><a href="{{route('sante.show', $post->slug)}}">{{$post->created_at}}</a></div>
								<div class="news_post_title"><a href="{{route('sante.show', $post->slug)}}">{{$post->title}}</a></div>
								...
								<div class="news_post_text">
									<p>{!!  str_limit($post->body, 500) !!} {{-- Limit teaser to 100 characters --}}</p>
								</div>
								<div class="button news_post_button"><a href="{{route('sante.show', $post->slug)}}"><span>lire plus</span><span>lire plus</span></a></div>
							</div>
						</div>
						@endforeach
				...
				<div class="col-lg-4">
					<div class="news_sidebar">
						...
						<div class="sidebar_latest">
							<div class="sidebar_title">Dernières articles</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_about">
							...
							<div class="copyright">
								&copy; <script>document.write(new Date().getFullYear());</script> CHU CAMPUS | Développé par <!--<i class="fa fa-heart-o" aria-hidden="true"></i>--> par l'<a href="https://telemedchucampus.tg#unite" target="_blank"> Unité de Télémedecine du CHU-CAMPUS</a>
							</div>
						</div>
					</div>
					...
					<!--<div class="col-lg-4 footer_col">
						<div class="footer_contact">
							<div class="footer_contact_title">Liens utiles</div>
								<div class="footer_contact_form_container">
										<li class="d-flex flex-row align-items-center justify-content-start"><a href="{{ route('index') }}">Accueil</a></li>

										<li class="d-flex flex-row align-items-center justify-content-start"><a href="{{ route('about') }}">A propos</a></li>

										<li class="d-flex flex-row align-items-center justify-content-start"><a href="{{ route('services') }}">Services</a></li>

										<li class="d-flex flex-row align-items-center justify-content-start"><a href="{{ route('blog.index') }}">Santé</a></li>

										<li class="d-flex flex-row align-items-center justify-content-start"><a href="{{ route('timeline') }}">Actualités</a></li>
										
										<li class="d-flex flex-row align-items-center justify-content-start"><a href="{{ route('contact') }}">Contact</a></li>
								</div>
						</div>
					</div>-->
