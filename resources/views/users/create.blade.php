...
<div class="row">
    <div class="col-lg-8 offset-lg-2">
        <form method="POST" action="{{ route('users.store') }}" class="form-signin" enctype="multipart/form-data">
        	@csrf
            <div class="row">
                <div class="col-sm-6">
            ...
            <div class="m-t-20 text-center">
                <button type="submit" class="btn btn-primary submit-btn">Ajouter Utilisateur</button>
            </div>
        </form>
    </div>
</div>
